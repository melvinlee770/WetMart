     ...
     return (
       <ImageBackground source={Background} style={styles.container}>
         ...
         <Card style={{height:'6%', 
                       ...
                       justifyContent: 'center', 
                       backgroundColor: '#5A9896'}}>
           <Text style={{color: 'white', fontFamily: 'Montserrat-Regular', fontSize: 20}} onPress = {() => navigation.navigate('signupScreen')}>SIGN UP</Text>
         </Card>
         <Text style={{color: 'black', fontFamily: 'Montserrat-Regular', fontSize: 15, marginLeft: 'auto', marginRight: 'auto'}} onPress = {() => navigation.navigate('resetpasswordScreen')}>Forget Password? Reset</Text>
